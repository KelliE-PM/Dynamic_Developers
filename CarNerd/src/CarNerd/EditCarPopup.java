...
public class EditCarPopup extends JPanel{
	...
	EditCarPopup(String btnTxt, JPanel aPanel, JDialog aDialog, String name, String year, String make, String model, String trim, String vin, String plate) {
